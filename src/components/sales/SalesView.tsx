    ...
    <div id="sales-view" className="space-y-4 pb-12">
                    ...
                    <div className="grid grid-cols-2 gap-1 text-xs">
                      {[
                        ...
                        <button
                          ...
                          className={`px-2.5 py-1.5 rounded-xl text-left font-semibold transition-colors flex items-center justify-between cursor-pointer ${dateFilter === preset.id
                      ...
                      <button
                        ...
                        className={`px-2.5 py-1.5 rounded-xl text-left font-semibold transition-colors flex items-center justify-between cursor-pointer ${dateFilter === 'custom' && customDateRange.startDate === '2020-01-01'
                            ? 'bg-emerald-50 text-emerald-900 font-bold border border-emerald-200'
                            : 'bg-slate-50 hover:bg-slate-100 text-slate-700'
                          }`}
                      >
      ...
      <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar scrollbar-none pb-1 bg-white p-2 rounded-2xl border border-slate-200 text-xs font-semibold">
        <button
          ...
          className={`px-3 py-1.5 rounded-xl whitespace-nowrap transition-all ${statusFilter === 'all' ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
            }`}
        >
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-xl whitespace-nowrap transition-all ${statusFilter === 'unpaid' ? 'bg-rose-600 text-white' : 'bg-rose-50 text-rose-700 hover:bg-rose-100'
            }`}
        >
          Unpaid
        </button>
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-xl whitespace-nowrap transition-all ${statusFilter === 'partially_paid' ? 'bg-amber-500 text-white' : 'bg-amber-50 text-amber-700 hover:bg-amber-100'
            }`}
        >
          Partially Paid
        </button>
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-xl whitespace-nowrap transition-all ${statusFilter === 'paid' ? 'bg-emerald-600 text-white' : 'bg-emerald-50 text-emerald-700 hover:bg-emerald-100'
            }`}
        >
          Paid in Full
        </button>
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-xl whitespace-nowrap transition-all ${statusFilter === 'cancelled' ? 'bg-slate-700 text-white' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
            }`}
        >
          Cancelled / Void
        </button>
            ...
            {filteredSales.map((sale) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`absolute top-0 left-0 right-0 h-1.5 ${isPaid
                        ? 'bg-emerald-500'
                        : isPartial
                          ? 'bg-amber-500'
                          : isCancelled
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start justify-between gap-2 pt-1">
                      ...
                      <span
                        className={`text-[10px] px-2.5 py-1 rounded-full font-bold uppercase tracking-wide shrink-0 ${isPaid
                  ...
                  {filteredSales.map((sale) => (
                    ...
                    >
                      ...
                      <td className="py-3 text-center">
                        <span
                          className={`text-[10px] px-2.5 py-0.5 rounded-full font-bold uppercase ${sale.paymentStatus === 'paid'
                              ? 'bg-emerald-100 text-emerald-800'
